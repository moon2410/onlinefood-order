    ...
    <section class="blogs">
        <div class="container">
            ...
            <div class="blog-box">
                ...
                <p><?php echo substr($row_blog['description'], 0, 150); ?>...<br><br><br></p>
...
<section class="categories">
    <div class="container">
        ...
        <?php 
            ...
            $sql = "SELECT * FROM tbl_category WHERE active='Yes' AND featured='Yes' ORDER BY id DESC LIMIT 15";
            // Execute the Query
        ...
        <a href="<?php echo SITEURL; ?>category-foodsh.php?category_id=<?php echo $id; ?>">
...
/* Form for managing blog settings */
...
.blog-settings input[type="text"], .blog-settings select {
    width: 100%;
    padding: 10px;
    margin: 10px 0;
    border-radius: 5px;
...
.blog-settings .btn:hover {
    background-color: #45a049;
}

.blog-settings .success, .blog-settings .error {
    font-size: 16px;
    margin-bottom: 10px;
    padding: 10px;
    border-radius: 5px;
